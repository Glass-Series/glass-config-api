...
public class StringListScreenBuilder extends ScreenBase {

    protected ScreenScrollList scrollList;
    protected final ScreenBase parent;
    protected int mouseX = -1;
    protected int mouseY = -1;
    protected ConfigEntry<List<String>> configEntry;
    public final List<ExtensibleTextbox> textboxes = new ArrayList<>();
    protected Function<String, Boolean> validator;
    protected final int maxLength;
    private boolean isInUse = false;

    public StringListScreenBuilder(ScreenBase parent, int maxLength, ConfigEntry<List<String>> configEntry, Function<String, Boolean> validator) {
        this.parent = parent;
    ...
    class ScreenScrollList extends ScrollableBase {
        public ScreenScrollList() {
            super(StringListScreenBuilder.this.minecraft, StringListScreenBuilder.this.width, StringListScreenBuilder.this.height, 32, StringListScreenBuilder.this.height - 64, 24);
        ...
        protected void renderBackground() {
            StringListScreenBuilder.this.renderBackground();
        }
        ...
        protected void renderEntry(int itemId, int x, int y, int i1, Tessellator arg) {
            ...
            StringListScreenBuilder.this.drawTextWithShadow(textManager, String.valueOf(itemId), x - 2 - textManager.getTextWidth(String.valueOf(itemId)), y + 1, 16777215);
